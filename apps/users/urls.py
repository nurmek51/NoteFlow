...
from .views import UserRegistrationView, UserDetailView, UserFavoriteLecturerUpdateDeleteView, \
    UserFavoriteSubjectsUpdateDeleteView, ProfilePictureUploadView, ProfilePictureDeleteView, VerifyEmailView
...
urlpatterns = [
    ...
    path("verify-email/<str:verification_code>/", VerifyEmailView.as_view(), name="verify-email"),  #get to validate email while register
